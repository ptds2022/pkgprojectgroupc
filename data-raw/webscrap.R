...
library(highcharter) # for creating interactive charts
library(tibble) # for tibble data manipulation
library(countrycode) # for converting country names to ISO 3166-1 alpha-3 codes
library(RSelenium) # for automating web browser interaction
library(dplyr) # for data manipulation
library(tidyr) # for data manipulation
library(tmaptools) # for creating maps
library(geosphere) # for geographical calculations

# This file is a wrangling file
# It retrieves the latest gas price and gas station data from the web and
# transforms the data in a digestible format
# This code can also be found in the R/webscrap_data.R function file
